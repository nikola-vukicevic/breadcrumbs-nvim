...
```lua
vim.api.nvim_set_hl ( 0 , "BreadcrumbsNormal" ,        { bg = "#2c323c" , fg = "#b0b0b0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsSeparator" ,     { bg = "#2c323c" , fg = "#807a74" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsFile" ,          { bg = "#2c323c" , fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsModule" ,        { bg = "#2c323c" , fg = "#80a0f0" } )
...
vim.api.nvim_set_hl ( 0 , "BreadcrumbsClass" ,         { bg = "#2c323c" , fg = "#80a0f0" } )
...
vim.api.nvim_set_hl ( 0 , "BreadcrumbsNumber" ,        { bg = "#2c323c" , fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsBoolean" ,       { bg = "#2c323c" , fg = "#80a0f0" } )
vim.api.nvim_set_hl ( 0 , "BreadcrumbsArray" ,         { bg = "#2c323c" , fg = "#80a0f0" } )
...
vim.api.nvim_set_hl ( 0 , "BreadcrumbsStruct" ,        { bg = "#2c323c" , fg = "#80a0f0" } )
